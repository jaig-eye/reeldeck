...
(function () {
  ...
  //   verified   - MIRROR family (autoplay=1), MIRROR (autoPlay=true), MIRROR
  //                (autoplay defaults to ON; passing autoplay=false is what disables it)
  //   unverified - MIRROR, MIRROR, MIRROR, MIRROR, MIRROR publish no
  ...
  const TRACK_SEED = { 'MIRROR': 1 };          // documents MEDIA_DATA / PLAYER_EVENT
  function trackedAll() {
