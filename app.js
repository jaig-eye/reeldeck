...
(function () {
  ...
  const DEFAULT_SOURCES = [
    ...
    { name: 'MIRROR',   movie: 'https://mirror.invalid/player/{id}',                         tv: 'https://mirror.invalid/player/{id}/{season}/{episode}' },
    { name: 'MIRROR',  movie: 'https://mirror.invalid/embed/movie/{id}',                  tv: 'https://mirror.invalid/embed/tv/{id}/{season}/{episode}' },
    { name: 'MIRROR',  movie: 'https://mirror.invalid/embed/movie/{id}',                  tv: 'https://mirror.invalid/embed/tv/{id}/{season}/{episode}' },
    ...
    { name: 'MIRROR',    movie: 'https://mirror.invalid/movie/{id}',                            tv: 'https://mirror.invalid/tv/{id}/{season}/{episode}' },
    { name: 'MIRROR',  movie: 'https://mirror.invalid/movie/{id}',                          tv: 'https://mirror.invalid/tv/{id}/{season}/{episode}' },
    { name: 'MIRROR',     movie: 'https://mirror.invalid/movie/{id}',                              tv: 'https://mirror.invalid/tv/{id}/{season}/{episode}?autoplay=true' },
    { name: 'MIRROR',     movie: 'https://mirror.invalid/movie/{id}?autoplay=true',  tv: 'https://mirror.invalid/tv/{id}?s={season}&e={episode}' }
  ];
